...
public class InventoryPage {
    ...
    public SelenideElement indicatorOfAddedProductsToTheCart = $ (byClassName("shopping_cart_badge"));

    public SelenideElement removeFirstProduct = $ (byTextCaseInsensitive("Remove"));
    public SelenideElement indicatorOfEmptyCart = $ (byClassName("shopping_cart_link"));
